...
| Report AUROC/AUPRC in one accessible artifact | `docs/tmp_md/method_cmp_four_center_results.html` includes four-center main table and method-specific sections | Done |
...
- HTML parse check passed for `docs/tmp_md/method_cmp_four_center_results.html`.
