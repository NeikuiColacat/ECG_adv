...
description: Use before staging, committing, or pushing ECG_manual_refactor changes to prevent large artifacts, external model links, credentials, and generated runs from entering Git.
---
