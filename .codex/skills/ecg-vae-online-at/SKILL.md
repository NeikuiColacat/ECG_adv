...
the clean-room mainline. `AGENTS.md`,
`docs/refactor_cleanup/manual_refactor_keep_manifest.md`,
`configs/train/lhat.yaml`, `configs/train/augmix.yaml`, and
`configs/train/methods/augmix_simclr_lhat.yaml` override historical settings in
this skill.
...
-> clean plus rotating depth2/3 supervision
-> exact-label non-self M20 VAE-LHAT attack-then-contract view
-> PN2021 Clean/PN2021-C drop-all-zero ref-excluded evaluation
```
...
Historical 2026-05-24 evidence:
...
Historical 2026-05-25 ECGFounder evidence:
