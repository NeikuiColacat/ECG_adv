...
ROOT = Path(
    ...
    "pn2021c_goal_effnet_officials5_c112_fourcenter_20260624/"
    "eval_c112_officials5_fourcenter"
)
LOGDIR = Path("/dev/shm/ecg_goal_c112_20260624")
DIRECT_ROOT = Path(
    "/home/linbinhao/ECG_adv_data/runs/"
...
class EvalTask:
    ...
    def log_path(self) -> Path:
        return LOGDIR / f"c112_{self.center}_eval_watch.log"
    ...
    def model_dir(self) -> Path | None:
        ...
        matches = sorted(
            p
            for p in self.train_root.glob(f"*fullft_{self.tag}_ep45_seed20260601")
            if p.is_dir()
        )
...
TAG = "c112officials5_safewarm_c24_b20_aw20_ep45"
TASKS = [
    EvalTask(
        "chapman_shaoxing",
        4,
        Path(
            "/home/linbinhao/ECG_adv_data/runs/"
            "effnet_vae_lhat_augmix_threechain_officials5_cand112_safewarm_c24_b20_aw20_ep45_chapman_shaoxing/"
            "goal_c112_effnet_chapman_20260624_train_threads4"
        ),
        TAG,
        ref_meta("chapman_shaoxing"),
        "goal_c112_effnet_chapman",
    ),
    EvalTask(
        "cpsc_2018",
        4,
    ...
    EvalTask(
        ...
        Path(
            "/home/linbinhao/ECG_adv_data/runs/"
            "effnet_vae_lhat_augmix_threechain_officials5_cand112_safewarm_c24_b20_aw20_ep45_ningbo/"
            "goal_c112_effnet_ningbo_20260624_train_threads4"
        ),
        TAG,
        ref_meta("ningbo"),
        "goal_c112_effnet_ningbo",
    ),
]
...
def summary_command() -> list[str]:
    ...
    cmd.extend(
        [
            ...
            str(ROOT / "summary"),
            "--prefix",
            "c112_fourcenter_official_s5_composite_method",
        ]
    )
    return cmd
...
def main() -> int:
    ...
    master_log = LOGDIR / "eval_supervisor_c112_fourcenter_20260624.log"
    append(master_log, "supervisor_start max_eval_gpus=2 threads=4")
    ...
    while True:
        ...
        if len(complete) == len(TASKS) and not summary_done:
            log_path = LOGDIR / "c112_fourcenter_summary_watch.log"
