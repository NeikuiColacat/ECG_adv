...
from scripts.triple_labels.eval_ecgfounder_pn2021_corruptions import (
    _ecg1000_ct_to_ecgfounder_5000_no_zscore,
)
...
def _clean_ct_for_mode(
    *,
    ...
    if mode == "bottleneck5000":
        ...
        return _ecg1000_ct_to_ecgfounder_5000_no_zscore(sig_ct).detach().cpu().numpy(), 500.0
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--scheme", default="super5")
