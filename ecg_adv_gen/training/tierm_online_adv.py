...
from ecg_adv_gen.preprocessing import (  # noqa: E402
    unified_preprocess_to_1000, crop_signal_tc,
)
from ecg_adv_gen.data.tierm_refs import (  # noqa: E402
...
def load_ptbxl_tierM_train_val():
    from ecg_adv_gen.labels.tier26 import get_ptbxl_26_labels
...
def main():
    ...
    print(f"    ecg_adv_gen/evaluation/tierm_crosscenter.py \\")
