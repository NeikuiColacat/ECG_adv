...
``effnet_direct_finetune.py``.  It keeps the same target-center
protocol, ref-excluded PN2021 v7 evaluation, and simple supervised baseline,
but initializes any model registered in ``ecg_adv_gen.models.super5_model_zoo``.
"""
...
from ecg_adv_gen.models.super5_model_zoo import available_model_names, build_super5_model, normalize_model_name  # noqa: E402
