"""Cross-center evaluator for the Super5 label scheme.
...
Usage:
    /root/miniforge3/envs/ECGTwin/bin/python ecg_adv_gen/runner/pn2021_clean_eval.py \
...
from ecg_adv_gen.labels import get_super5_scheme, get_super5_pn2021_mapping_metadata
from ecg_adv_gen.models.super5_model_zoo import (
    available_model_names, build_super5_model, normalize_model_name,
)
from ecg_adv_gen.data.ptbxl import get_ptbxl_labels_for_scheme
from ecg_adv_gen.data.pn2021 import load_or_build_pn2021_center
from ecg_adv_gen.evaluation import compute_macro_auroc_auprc
from ecg_adv_gen.preprocessing import crop_signal_tc
from ecg_adv_gen.training import PTBXLDatasetScheme, masked_bce_with_logits
...
def eval_pn2021(model, scheme, args, device):
    ...
    for center in PN2021_CENTERS:
        ...
        signals, labels, record_ids, fail, load_time, cache_hit, cache_kind = load_or_build_pn2021_center(
