...
from ecg_adv_gen.evaluation.ref_exclusion import target_ref_meta_paths  # noqa: E402
...
def ref_ids_for_all_centers(
    ...
    ref_ids = {}
    try:
        ref_ids = load_ref_record_ids_by_center(
            target_ref_meta_paths(ref_root, k=500, seed=20260531, centers=TARGET_CENTERS)
        )
    except Exception:
...
def train_one_center(
    ...
    if args.enable_raw_corrupt_consistency:
        ...
        print(
            ...
            f"schedule={args.raw_augmix_op_schedule},"
