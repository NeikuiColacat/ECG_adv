...
def build_effnet_vae_lhat_train_cmd(
    ...
    *,
    ...
    train_cmd = [
        ...
        "--hull_weight_mode",
        str(getattr(args, "hull_weight_mode", "optimized")),
        "--hull_dirichlet_alpha",
        str(getattr(args, "hull_dirichlet_alpha", 1.0)),
        "--hull_label_mode",
        ...
        str(getattr(args, "anchor_class_weights", "")),
        "--anchor_class_weight_mode",
        str(getattr(args, "anchor_class_weight_mode", "manual")),
        "--anchor_class_weight_reference_source",
        str(getattr(args, "anchor_class_weight_reference_source", "real_anchor")),
        "--anchor_class_weight_gamma",
        str(getattr(args, "anchor_class_weight_gamma", 0.5)),
        "--anchor_class_weight_min",
        str(getattr(args, "anchor_class_weight_min", 0.35)),
        "--anchor_class_weight_cap",
        str(getattr(args, "anchor_class_weight_cap", 4.0)),
        "--anchor_class_missing_weight",
        str(getattr(args, "anchor_class_missing_weight", 0.35)),
        "--K_anchor",
        str(args.k_anchor),
        "--pgd_eps",
        ...
        *[str(item) for item in args.classes_in_scope],
        ...
        str(getattr(args, "vae_adv_consistency_weight", 0.0)),
        ...
        str(getattr(args, "adv_soft_target_floor", 0.0)),
        "--disable_quality_gate",
        "--lr",
        str(args.lr),
        "--grad_clip",
        str(getattr(args, "grad_clip", 1.0)),
        "--weight_decay",
        "1e-4",
        "--batch_size",
        ...
        "--boundary_prob_min",
        str(getattr(args, "boundary_prob_min", 0.0)),
        "--boundary_prob_max",
        str(getattr(args, "boundary_prob_max", 1.0)),
        "--einthoven_p95_max",
        str(getattr(args, "einthoven_p95_max", 0.5)),
        "--num_workers",
    ...
    train_cmd.extend(
        [
            ...
            str(getattr(args, "latent_augmix_adv_base_mix", 1.0)),
