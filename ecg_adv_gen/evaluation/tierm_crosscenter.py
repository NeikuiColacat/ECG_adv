...
Package-owned Tier-M variant with:
...
Usage:
    /root/miniforge3/envs/ECGTwin/bin/python ecg_adv_gen/evaluation/tierm_crosscenter.py \
...
from ecg_adv_gen.labels.tier26 import (
    TIER_M, TIER_M_IDX, NUM_CLASSES_TIER_M,
    ALL_SCORED_SNOMED, snomed_to_26, has_any_scored_class,
)
from ecg_adv_gen.preprocessing import unified_preprocess_to_1000, crop_signal_tc
